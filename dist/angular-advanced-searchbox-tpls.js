        ...
        return {
            ...
            controller: [
                ...
                function ($scope, $attrs, $element, $timeout, $filter) {
                    ...
                    $scope.searchParams = [];
                    $scope.searchQuery = '';
                    $scope.paramaterLimit = $scope.paramaterLimit || 8;
